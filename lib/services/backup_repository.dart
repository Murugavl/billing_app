    ...
    final Map<String, dynamic> exportMap = {
      ...
      'businessProfile': profile == null
          ...
          : {
              ...
              'defaultIncludeBankDetailsInvoice': profile.defaultIncludeBankDetailsInvoice,
              'defaultIncludeBankDetailsEstimate': profile.defaultIncludeBankDetailsEstimate,
      ...
      if (data['businessProfile'] != null) {
        ...
        await db.into(db.businessProfile).insert(
              BusinessProfileCompanion(
                ...
                invoiceNumberPrefix: Value(bp['invoiceNumberPrefix'] ?? 'INV'),
                invoiceNumberFormat: Value(bp['invoiceNumberFormat'] ?? '{PREFIX}-{SEQ}'),
                invoiceNumberPadding: Value(bp['invoiceNumberPadding'] ?? 4),
                invoiceNumberSeparator: Value(bp['invoiceNumberSeparator'] ?? '-'),
                invoiceNextSequence: Value(bp['invoiceNextSequence'] ?? 1),
                estimateNumberPrefix: Value(bp['estimateNumberPrefix'] ?? 'EST'),
                estimateNumberFormat: Value(bp['estimateNumberFormat'] ?? '{PREFIX}-{SEQ}'),
                estimateNumberPadding: Value(bp['estimateNumberPadding'] ?? 4),
                estimateNumberSeparator: Value(bp['estimateNumberSeparator'] ?? '-'),
                estimateNextSequence: Value(bp['estimateNextSequence'] ?? 1),
                purchaseNumberPrefix: Value(bp['purchaseNumberPrefix'] ?? 'PUR'),
                purchaseNumberFormat: Value(bp['purchaseNumberFormat'] ?? '{PREFIX}-{SEQ}'),
                purchaseNumberPadding: Value(bp['purchaseNumberPadding'] ?? 4),
                purchaseNumberSeparator: Value(bp['purchaseNumberSeparator'] ?? '-'),
                purchaseNextSequence: Value(bp['purchaseNextSequence'] ?? 1),
                defaultIncludeBankDetailsInvoice: Value(bp['defaultIncludeBankDetailsInvoice'] ?? true),
                defaultIncludeBankDetailsEstimate: Value(bp['defaultIncludeBankDetailsEstimate'] ?? true),
